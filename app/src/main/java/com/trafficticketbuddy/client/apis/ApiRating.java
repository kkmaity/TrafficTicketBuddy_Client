...
public class ApiRating {
    ...
    public ApiRating(Map<String, String> param, OnApiResponseListener listener) {
        this.param = param;
    ...
    public void doWebServiceCall() {
        ...
        Call<ResponseBody> getDepartment = RestService.getInstance().restInterface.rating(param);
